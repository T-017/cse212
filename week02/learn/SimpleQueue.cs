public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Trying to remove date from index 1 but should be index 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue inserted at the front, not the back of the queue
        ...
        // Defect(s) Found: No defects found in this test case
    }
